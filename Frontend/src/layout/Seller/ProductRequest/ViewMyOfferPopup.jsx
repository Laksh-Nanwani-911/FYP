...
const ViewMyOfferPopup = ({ setViewMyOfferPopup, offers }) => {
  ...
  return (
    <div className="bg-white p-2 sm:w-[80%] md:w-[80%] rounded-md h-[70vh] font-mont sm:m-0 m-3">
      <div className="flex justify-between items-center">
        <h1 className="text-lg">View My Offers</h1>
        <ImCross
          onClick={() => setViewMyOfferPopup(false)}
            ...
            <table className="w-full">
              ...
              <tbody>
                {offers
                  ...
                  .map((item, index) => {
                    if (item.user._id == localStorage.getItem("sellerId")) {
                      return (
                        <tr key={item?._id}>
...
export default ViewMyOfferPopup;
