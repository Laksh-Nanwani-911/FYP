...
const CreateProductRequestPopup = ({
  setCreateProductPopup,
  setReFetch,
  reFetch,
}) => {
  ...
  const submitData = async () => {
    setloader(true);
    if (!productDeatls.description || !productDeatls.title) {
      setloader(false);
      ...
      axios
        .post(`${baseUrl}/product-request/create-new-request`, bodyData, {
          headers: {
  ...
  return (
    <div className="bg-white p-2 sm:w-[50%] md:w-[60%] rounded-md font-mont sm:m-0 m-3">
      <div className="flex justify-between items-center">
        <h1 className="text-lg">Create Product Request</h1>
        <ImCross
          onClick={() => setCreateProductPopup(false)}
...
export default CreateProductRequestPopup;
