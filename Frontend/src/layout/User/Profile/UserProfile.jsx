      ...
      <div className="w-[100%] shadow-cardShadow p-3 rounded-md font-lato">
        {loading ? (
          ...
          <div>
            ...
            <div
              style={{ border: "1px solid lightgray" }}
              className="rounded-3xl w-max flex justify-center items-center mt-3 shadow-otpShadow bg-[#4f619f] mx-auto"
            ...
            <div
              style={{ border: "1px solid lightgray,"}}
              className="rounded-3xl flex justify-center items-center mt-3 shadow-otpShadow bg-[#4f619f] w-max mx-auto "
              onClick={() => {
